...
#
elf2flash --input="/afs/ualberta.ca/home/b/m/bmaroney/G4Capstone/software/WebServer/WebServer.elf" --output="../flash/WebServer_generic_tristate_controller_0.flash" --boot="$SOPC_KIT_NIOS2/components/altera_nios2/boot_loader_cfi.srec" --base=0x400000 --end=0x800000 --reset=0x400000 
