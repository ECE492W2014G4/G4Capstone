...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9090a0
SOPC_SYSID_FLAG += --sidp=0x9090a0
ELF_PATCH_FLAG  += --sidp 0x9090a0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1460430791
SOPC_SYSID_FLAG += --timestamp=1460430791
ELF_PATCH_FLAG  += --timestamp 1460430791
