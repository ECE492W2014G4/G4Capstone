...
# Sun Apr 03 21:48:28 MDT 2016
# DO NOT MODIFY


# 
# dsp "dsp" v1.0
# null 2016.04.03.21:48:28
# 
# 
...
add_interface_port clipping clipping_write_n write_n Input 1
...
# 
# connection point clipping_test
# 
add_interface clipping_test avalon end
set_interface_property clipping_test addressUnits WORDS
set_interface_property clipping_test associatedClock clock
set_interface_property clipping_test associatedReset reset_n
set_interface_property clipping_test bitsPerSymbol 8
set_interface_property clipping_test burstOnBurstBoundariesOnly false
set_interface_property clipping_test burstcountUnits WORDS
set_interface_property clipping_test explicitAddressSpan 0
set_interface_property clipping_test holdTime 0
set_interface_property clipping_test linewrapBursts false
set_interface_property clipping_test maximumPendingReadTransactions 0
set_interface_property clipping_test readLatency 0
set_interface_property clipping_test readWaitTime 1
set_interface_property clipping_test setupTime 0
set_interface_property clipping_test timingUnits Cycles
set_interface_property clipping_test writeWaitTime 0
set_interface_property clipping_test ENABLED true

add_interface_port clipping_test clipping_readdata readdata Output 16
set_interface_assignment clipping_test embeddedsw.configuration.isFlash 0
set_interface_assignment clipping_test embeddedsw.configuration.isMemoryDevice 0
set_interface_assignment clipping_test embeddedsw.configuration.isNonVolatileStorage 0
set_interface_assignment clipping_test embeddedsw.configuration.isPrintableDevice 0
